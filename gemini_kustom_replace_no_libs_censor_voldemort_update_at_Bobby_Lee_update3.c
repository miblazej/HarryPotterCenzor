...
void cenzuruj_voldemorta(char *tekst) {
    ...
    const char *zamiennik = "Lord Pedoford,Okupant Francuski,Pies Saracenski, Budda Snake Eater, Rattlesnake, PornBaron,Sancho Pansa,Do Diaska Napisał,Irish King, ilegal Haym Salamon that opposed George Washinton orders same as illegal briber into Wales kreation family member,SciLexer.dll, irl Natheniel escupe mi mierda Rotschild do not miks up with for eksample Dobrawa Rotshild";
