...
void cenzuruj_voldemorta(char *tekst) {
    ...
    const char *zamiennik = "Lord Pedoford, Budda Sneak Eater, Rattlesnake, PornBaron,Sancho Pansa,Do Diaska Napisał,Irish King, irl Natheniel escupe mi mierda Rotschild do not miks up with for eksample Dobrawa Rotshild";
